...
(cl:defmethod cl:initialize-instance :after ((m <destinate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'destinate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Flight-srv:<destinate-request> is deprecated: use Flight-srv:destinate-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <destinate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Flight-srv:x-val is deprecated.  Use Flight-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <destinate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Flight-srv:y-val is deprecated.  Use Flight-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <destinate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Flight-srv:z-val is deprecated.  Use Flight-srv:z instead.")
  (z m))
...
(cl:defmethod cl:initialize-instance :after ((m <destinate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'destinate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Flight-srv:<destinate-response> is deprecated: use Flight-srv:destinate-response instead.")))

(cl:ensure-generic-function 'des_r-val :lambda-list '(m))
(cl:defmethod des_r-val ((m <destinate-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Flight-srv:des_r-val is deprecated.  Use Flight-srv:des_r instead.")
  (des_r m))
